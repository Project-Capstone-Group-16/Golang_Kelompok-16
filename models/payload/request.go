...
type CreateStaffRequest struct {
	...
	WorkingHours string `json:"working_hours" form:"working_hours" validate:"required,number"`
...
type UpdateStaffRequest struct {
	...
	WorkingHours string `json:"working_hours" form:"working_hours" validate:"omitempty,gt=0,number"`
	BirthDate    string `json:"birth_date" form:"birth_date"`
